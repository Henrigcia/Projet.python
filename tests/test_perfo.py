...
def test_load_level(window :arcade.Window) -> None:
    ...
    res1 = timeit.timeit(lambda: gv.load_level("maps/map1.txt"), number=number)
    res2 = timeit.timeit(lambda: gv.load_level("maps/maptest2.txt"), number=number)
    res3 = timeit.timeit(lambda: gv.load_level("maps/maptest3.txt"), number=number)
    res4 = timeit.timeit(lambda: gv.load_level("maps/maptest5.txt"), number=number)
    res5 = timeit.timeit(lambda: gv.load_level("maps/maptest5.txt"), number=number)
    res6 = timeit.timeit(lambda: gv.load_level("maps/maptest6.txt"), number=number)
    print(re1 / number)
    print(re2 / number)
    print(re3 / number)
    print(re4 / number)
